...
const Products: React.FC<ProductProps> = ({params}) => {
    ...
    const [tempItem, setTempItem] = useState<Item>({id: 0, img: '', name: '', originalPrice: 0, price: 0, discountPrice:Products.discountedPrice, discountedPrice: Products.discountedPrice,  color: '', size: '', quantity: 1, key: ''});
