            ...
            Object.keys(allproducts).map((item: string,index)=> (
                ...
                <div className="p-4">
                    ...
                    <p className={`text-black text-md font-semibold`}>
                        {
                            index === 0 || index === 7 || index === 1 || index === 8? <span className="line-through mr-2 text-red-600">Sold Out</span> : <span>₵{products[item as keyof typeof products].price}</span>
                        }                        
                    ...
                    {index === 0 || index === 7 || index === 1 || index === 8? (
                            <button
