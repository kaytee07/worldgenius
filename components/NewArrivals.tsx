...
const NewArrivals = () => {
  return (
    <div className="flex justify-center flex-col mb-6 items-center">
    <div className="flex justify-center py-6">
        <h1>NEW ARRIVALS</h1>
    </div>
    <ul className='flex max-sm:flex-col max-sm:items-center gap-4 md:w-[66rem] justify-center'>
    {
        ghanaBabe.map((item,index)=> (
        <div key={index} className="relative flex flex-col bg-white shadow-sm border border-slate-200 md:w-72">
